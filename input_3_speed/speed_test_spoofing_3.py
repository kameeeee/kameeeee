...
serializers.load_npz("./learned/7_Linear1_100_LSTM2_100_Linear1_100_interval_50_delta300_15.model", model)
...
plt.plot(attacker, 'r' '--')
plt.plot(SpeedData[1:1050], '-.')
ax2 = fig.add_subplot(212)
plt.title('test data')
plt.xlabel('time')
plt.ylabel('brake amount')
ax2.plot(BrakeData[1:1050], 'g', label='test data(brake amount)')
ax3 = ax2.twinx()  # 2つのプロットを関連付ける
ax3.plot(AccelatorData[1:1050], 'm', label='test data(accelator amount)')
