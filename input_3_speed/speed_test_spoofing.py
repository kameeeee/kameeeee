...
serializers.load_npz("/home/kame2/workspace/model/defore_dataset_learned/decimation1_50node_3/decimation1_50node_3.model", model)
...
plt.plot(attacker, 'r' '--')
plt.plot(SpeedData[1:], '-.')
ax2 = fig.add_subplot(212)
plt.title('test data')
plt.xlabel('time (minutes)', fontsize=22)
plt.ylabel('brake amount')
plt.tick_params(labelsize=18)
ax2.plot(BrakeData[1:], 'g', label='test data(brake amount)')
ax3 = ax2.twinx()  # 2つのプロットを関連付ける
ax3.plot(AccelatorData[1:], 'm', label='test data(accelator amount)')
